    ...
    <section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center overflow-hidden pb-12 md:pb-20">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 pt-8 md:pt-20 flex flex-col items-center">
           ...
           <div className="relative group cursor-pointer">
             ...
             <div className="relative inline-flex items-center gap-2 md:gap-3 px-4 md:px-6 py-2 md:py-2.5 rounded-full bg-white border border-gray-100 shadow-xl hover:scale-105 transition-transform">
                ...
                <span className="text-zencial-dark font-black tracking-widest uppercase text-[10px] md:text-sm">
                  CREATORS ZENCIAL 2026 • FAÇA PARTE
                </span>
             </div>
           </div>
        </div>
        ...
        <div className="text-center max-w-5xl mx-auto relative mb-8 md:mb-12 px-2">
             <h1 className="text-[3rem] leading-[0.9] sm:text-[3.5rem] md:text-[5.5rem] lg:text-[7.5rem] font-black text-zencial-dark tracking-tighter mb-6 md:mb-8 animate-slide-up relative z-20" style={{animationDelay: '0.1s'}}>
               SEJA UM CREATOR <br className="md:hidden" />
               <span className="text-transparent bg-clip-text bg-gradient-to-r from-zencial-pink via-purple-600 to-indigo-600 uppercase"> ZENCIAL</span>
        ...
        {/* Buttons - Aligned to top on desktop, stacked on mobile */}
        <div className="w-full max-w-md md:max-w-none flex flex-col md:flex-row items-center md:items-start md:justify-center gap-4 animate-slide-up mb-12 md:mb-20 px-4" style={{animationDelay: '0.3s'}}>
            <button 
              onClick={onScrollToVerify}
              className="w-full md:w-auto px-8 md:px-10 py-4 md:py-5 bg-zencial-dark text-white rounded-2xl font-black text-lg md:text-xl hover:bg-zencial-pink hover:scale-105 transition-all duration-300 shadow-[0px_10px_20px_rgba(0,0,0,0.2)] flex items-center justify-center gap-3 group"
            >
              Verificar Perfil
            ...
            <div className="w-full md:w-auto flex flex-col items-center">
              <button 
                disabled 
                className="w-full md:w-auto flex items-center justify-center gap-3 px-6 py-4 md:py-5 rounded-2xl transition-all border-2 border-gray-200 bg-gray-50 opacity-60 cursor-not-allowed grayscale"
              >
        ...
        <div className="relative w-full max-w-6xl h-[400px] md:h-[600px] mt-4 hidden md:block animate-slide-up" style={{animationDelay: '0.4s'}}>
             ...
             <div className="absolute left-1/2 top-0 -translate-x-1/2 w-[300px] md:w-[400px] h-[500px] bg-black rounded-[3rem] overflow-hidden border-4 border-white shadow-2xl z-20 hover:scale-[1.02] transition-transform duration-500">
                <img src="https://cdn.shopify.com/s/files/1/0673/0950/2681/files/freepik__troque-a-caixa__58902.png?v=1769101039?v=1769096237?q=80&w=1000&auto=format&fit=crop" className="w-full h-full object-cover" alt="Self-care Session" />
                ...
                <div className="absolute bottom-8 left-6 right-6 flex flex-col items-center text-center">
                   <div className="inline-flex items-center gap-3 mb-4 bg-neutral-900/90 backdrop-blur-xl px-5 py-2 rounded-full border border-white/20 shadow-xl transform hover:scale-105 transition-transform">
                      <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-zencial-pink shadow-md">
                         <img src="https://ui-avatars.com/api/?name=Z&background=ec4899&color=fff" alt="Avatar" />
                      </div>
                      <p className="text-white text-sm font-black tracking-wide">@zencial</p>
                   </div>
             ...
             <div className="absolute left-[10%] top-20 w-64 h-80 bg-zencial-purple rounded-[2.5rem] overflow-hidden -rotate-6 border-4 border-white shadow-xl z-10 opacity-90 hover:z-30 hover:scale-110 transition-all duration-300 group">
                <img src="https://images.unsplash.com/photo-1590439471364-192aa70c0b53?q=80&w=800&auto=format&fit=crop" className="w-full h-full object-cover mix-blend-overlay" alt="Skincare Product" />
             ...
             <div className="absolute right-[10%] top-20 w-64 h-80 bg-pink-100 rounded-[2.5rem] overflow-hidden rotate-6 border-4 border-white shadow-xl z-10 opacity-90 hover:z-30 hover:scale-110 transition-all duration-300">
                <img src="https://cdn.shopify.com/s/files/1/0673/0950/2681/files/a21ecd2d-7656-42a5-9548-a76f27d5cabd.jpg?v=1769101514?q=80&w=800&auto=format&fit=crop" className="w-full h-full object-cover" alt="Serum Application" />
        ...
        <div className="md:hidden w-full max-w-[280px] xs:max-w-xs relative mt-4 mb-8 animate-slide-up">
             <div className="aspect-[3/4] bg-black rounded-[2rem] overflow-hidden border-4 border-white shadow-2xl relative">
                <img src="https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?q=80&w=600&auto=format&fit=crop" className="w-full h-full object-cover opacity-90" alt="Mobile Hero Skincare" />
                <div className="absolute inset-0 flex items-center justify-center">
